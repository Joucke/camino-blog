<template>
    <div ref="drop-area" class="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-blue-200 border-dashed rounded-md cursor-pointer">
        <div class="text-center">
            <svg class="mx-auto h-12 w-12 text-blue-800" stroke="currentColor" fill="none" viewBox="0 0 48 48">
